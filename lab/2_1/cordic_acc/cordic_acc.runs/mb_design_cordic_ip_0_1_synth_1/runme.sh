...
HD_PWD='D:/Studia/Magisterka/1_semestr/sdup/lab/2_1/cordic_acc/cordic_acc.runs/mb_design_cordic_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_design_cordic_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_design_cordic_ip_0_1.tcl
