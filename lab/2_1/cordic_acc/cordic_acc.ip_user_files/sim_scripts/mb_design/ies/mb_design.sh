...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../cordic_acc.srcs/sources_1/bd/mb_design/ipshared/85a3" \
       +incdir+"$ref_dir/../../../../cordic_acc.srcs/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../cordic_acc.srcs/sources_1/bd/mb_design/ipshared/85a3" \
