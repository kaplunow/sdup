...
//////////////////////////////////////////////////////////////////////////////////
module cordic_pipe_rtl( clock, reset, ce, angle_in, sin_ellipse, cos_ellipse, valid_out );
...
output [W-1:0] sin_ellipse, cos_ellipse;
...
wire signed [W-1:0] sin_out, cos_out;
//
...
//Stage a14 - 18: scaling of the results
	...
	ellipse_rtl ellipse_sin ( clock, ce, sin_out, sin_ellipse, 3 );
	ellipse_rtl ellipse_cos ( clock, ce, cos_out, cos_ellipse, 7 );
endmodule