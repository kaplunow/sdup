...
reg [11:0] angle_in;
real angle;
wire [11:0] sin_ellipse, cos_ellipse;
wire valid_out;
//For easy output value monitoring
real real_cos, real_sin;
//Instantiation
cordic_pipe_rtl cordic ( clock, reset, ce, angle_in, sin_ellipse, cos_ellipse, valid_out );
//Reset stimuli
initial
begin
	reset <= 1'b1;
...
begin
	...
	real_cos = cos_ellipse;
	real_sin = sin_ellipse;
