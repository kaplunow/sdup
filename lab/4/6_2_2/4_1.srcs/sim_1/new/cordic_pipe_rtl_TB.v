...
reg [11:0] angle_in;
real angle;
wire [11:0] eclipse_sin_out, eclipse_cos_out;
wire valid_out;
//For easy output value monitoring
real real_cos, real_sin;
//Instantiation
cordic_pipe_rtl cordic ( clock, reset, ce, angle_in, eclipse_sin_out, eclipse_cos_out, valid_out );
//Reset stimuli
initial
begin
	reset <= 1'b1;
...
begin
	...
	real_cos = eclipse_cos_out;
	real_sin = eclipse_sin_out;
