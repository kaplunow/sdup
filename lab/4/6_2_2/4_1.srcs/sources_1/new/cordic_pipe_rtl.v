...
//////////////////////////////////////////////////////////////////////////////////
module cordic_pipe_rtl( clock, reset, ce, angle_in, eclipse_sin_out, eclipse_cos_out, valid_out );
...
output [W-1:0] eclipse_sin_out, eclipse_cos_out;
...
//Exercise 6.2 - behavioral model of eclipse model
    eclipse_mod_beh eclipse_sin ( clock, ce, sin_out, 7, eclipse_sin_out);
    eclipse_mod_beh eclipse_cos ( clock, ce, cos_out, 3, eclipse_cos_out);
