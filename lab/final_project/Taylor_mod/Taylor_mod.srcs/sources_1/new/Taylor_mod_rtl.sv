...
parameter   S1 = 4'h01, S2 = 4'h02, S3 = 4'h03, S4 = 4'h04, S5 = 4'h05,
            S6 = 4'h06, S7_1 = 4'h07, S8 = 4'h08, S9 = 4'h09, S10 = 4'h0a,
            S2_1 = 4'h0b, S7_2 = 4'h0c, S13 = 4'h0d;
reg [3:0] state;
    ...
    begin
        case(state)
            ...
            S2: begin
                ...
                if(x[WIDTH-1] == 1) state <= S2_1; else state <= 3; //Checking if the number is negative
            end
