...
HD_PWD='C:/sdup/lab/final_project/Taylor_mod/Taylor_mod.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Taylor_mod_rtl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Taylor_mod_rtl.tcl
