...
HD_PWD='C:/sdup/lab/7/cordic/cordic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_rtl6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cordic_rtl6.tcl -notrace
