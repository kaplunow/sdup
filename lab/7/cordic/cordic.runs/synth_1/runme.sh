...
HD_PWD='C:/sdup/lab/7/cordic/cordic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_rtl6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_rtl6.tcl
