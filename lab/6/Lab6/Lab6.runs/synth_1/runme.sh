...
HD_PWD='C:/sdup/lab/6/Lab6/Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul24_ins_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul24_ins_tb.tcl
